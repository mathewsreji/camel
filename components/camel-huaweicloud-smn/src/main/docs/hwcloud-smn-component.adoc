...
= HuaweiCloud Simple Message Notification Component
:docTitle: HuaweiCloud Simple Message Notification
:artifactId: camel-huaweicloud-smn
:description: Component to integrate with HuaweiCloud Simple Message Notification services
:since: 3.8
...
Huawei Cloud SMN component allows you to integrate with Simple notification services[https://www.huaweicloud.com/en-us/product/smn.html] provided by Huawei cloud.
...
The Simple Message Notification component supports 2 options, which are listed below.
...
The Simple Message Notification endpoint is configured using URI syntax:
